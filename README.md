...
Tool ini hanya fokus pada proses geocoding Google Maps dari file CSV.
...
### 3) retry
Memproses ulang file gagal (biasanya `hasil_geocoding_gagal.csv`) dengan strategi alamat saja.
...
## Catatan
- Threshold similarity saat ini `40%`.
